...
@Composable
fun StepsGraphView(points: List<LineChartData.Point>) {
    ...
    Column(
        ...
        StepsGraphRow(points)
    }
}

@Composable
fun StepsGraphRow(points: List<LineChartData.Point>) {
    val stepsModel = StepsViewModel()
    val stepsData by remember {
